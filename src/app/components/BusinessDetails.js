export default function BusinessDetails() {
    const details = [
        ...
        {
            text: "We have one screen and play two movies each night we're open. One movie plays after another with a brief intermission in between.",
        },
        {
    ...
    return (
        <ul className="bg-neutral text-white text-xl text-center mx-2 mt-5 mb-2 space-y-4 p-5 rounded-lg">
