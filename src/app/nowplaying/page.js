            ...
            <div className="w-full max-w-screen-xl px-8 h-[85vh] flex">
                <section className="grid grid-cols-1 sm:grid-cols-2 gap-10 w-full justify-items-stretch flex-grow">
                    {nowPlaying.map((movie, index) => (
                        <div
                            className="bg-secondary text-secondary-content shadow-lg rounded-lg p-5 h-full flex flex-col justify-between transition-transform transform hover:scale-105 w-full"
