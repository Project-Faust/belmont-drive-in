  ...
  return (
    ...
    <div>
      ...
      <div className="flex justify-evenly">
        ...
        <main className="flex justify-center mx-2">
          <ul className="text-xl text-center mx-2 mt-5 mb-2">
            <li className="">
              ...
              <br />
              You can find us at <a className="text-blue-600 hover:underline" href="https://www.google.com/maps/dir//Belmont+Drive-In+314+McAdenville+Rd+Belmont,+NC+28012/@35.256076,-81.0586444,16z/data=!4m8!4m7!1m0!1m5!1m1!1s0x8856bdea1cb81aa9:0xdda9335f9ba8dbe9!2m2!1d-81.0586444!2d35.256076?entry=ttu&g_ep=EgoyMDI1MDIxMi4wIKXMDSoJLDEwMjExMjMzSAFQAw%3D%3D" target="_blank" rel="noreferrer">314 McAdenville Rd, Belmont NC 28120</a>.
            </li>
            <br />
            <li>
